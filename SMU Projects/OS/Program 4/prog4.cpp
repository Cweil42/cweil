...
int main() {
    ...
    */
    int numInts;
    fstream in("/Users/colinweil/Downloads/prog4test/test3.txt");
    in >> numInts;
...
//	   int res = Page_Replacement_LRU(pages, pagelist[i], prds1);
     int res = Page_Replacement_2nd(pages, pagelist[i], prds2);
//	   int res = Page_Replacement_MyOwn(pages, pagelist[i], prds3);
